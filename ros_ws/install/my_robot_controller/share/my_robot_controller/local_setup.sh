...
: ${AMENT_CURRENT_PREFIX:="/home/kk/github/ros2_control_moveit_6-dor-arm/ros_ws/install/my_robot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_robot_controller/environment/library_path.sh"
